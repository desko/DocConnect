...
const CustomAccordion = () => {
  return (
    <Accordion defaultIndex={[0]} allowMultiple allowToggle display='flex' flexDirection='column' gap='1.5rem'>
      <AccordionItem>

        <AccordionButton
          borderRadius='4px 4px 0 0'
          _expanded={{backgroundColor: '#d1d1d1'}}
        ...
        <AccordionPanel padding='3rem 2.5rem' borderRadius='0 0 4px 4px' backgroundColor='#f5f5f3'>
          <Flex
